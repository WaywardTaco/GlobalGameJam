...
[CreateAssetMenu(fileName = "New WorldEvent", menuName = "Scriptables/WorldEvents/UpgradeEvents/DownpaymentEvent", order = 1)]
public class Downpayment : GameWorldEventScriptable
{
