...
[CreateAssetMenu(fileName = "New WorldEvent", menuName = "Scriptables/WorldEvents/UpgradeEvents/DiversityEvent", order = 1)]
public class Diversity : GameWorldEventScriptable
{
