...
[CreateAssetMenu(fileName = "New WorldEvent", menuName = "Scriptables/WorldEvents/UpgradeEvents/NarrativeEvent", order = 1)]
public class Narrative : GameWorldEventScriptable
{
