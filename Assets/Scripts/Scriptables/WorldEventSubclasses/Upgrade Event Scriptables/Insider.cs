...
[CreateAssetMenu(fileName = "New WorldEvent", menuName = "Scriptables/WorldEvents/UpgradeEvents/InsiderEvent", order = 1)]
public class InsiderEvent : GameWorldEventScriptable
{
