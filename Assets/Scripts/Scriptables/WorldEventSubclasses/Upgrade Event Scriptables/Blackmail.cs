...
[CreateAssetMenu(fileName = "New WorldEvent", menuName = "Scriptables/WorldEvents/UpgradeEvents/BlackmailEvent", order = 1)]
public class Blackmail : GameWorldEventScriptable
{
