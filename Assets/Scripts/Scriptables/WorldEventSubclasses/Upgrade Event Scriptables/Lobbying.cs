...
[CreateAssetMenu(fileName = "New WorldEvent", menuName = "Scriptables/WorldEvents/UpgradeEvents/LobbyEvent", order = 1)]
public class Lobbying : GameWorldEventScriptable
{
