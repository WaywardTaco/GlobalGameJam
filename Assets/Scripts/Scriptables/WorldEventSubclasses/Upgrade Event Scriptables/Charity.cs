...
[CreateAssetMenu(fileName = "New WorldEvent", menuName = "Scriptables/WorldEvents/UpgradeEvents/CharityEvent", order = 1)]
public class CharityEvent : GameWorldEventScriptable
{
